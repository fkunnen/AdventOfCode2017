...
public class Day12_2Test {
    ...
    private Day12_2 day12_2 = new Day12_2();

    @Test
    public void digitalPlumber_example() {
        String input =
                "0 <-> 2\n" +
                "1 <-> 1\n" +
                "2 <-> 0, 3, 4\n" +
        ...
        int numberOfGroups = day12_2.digitalPlumber(input);

        Assertions.assertThat(numberOfGroups).isEqualTo(2);
    }
    ...
    public void digitalPlumber() {
        ...
        System.out.println("Day 12 part 2: " + day12_2.digitalPlumber(input));
    }
}
