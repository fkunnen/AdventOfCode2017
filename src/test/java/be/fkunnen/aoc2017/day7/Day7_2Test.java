...
public class Day7_2Test {
    ...
    private Day7_2 day7_2 = new Day7_2();

    @Test
    public void recursiveCircus_example_tknk() {
        String input =
                "pbga (66)\n" +
                "xhth (57)\n" +
                "ebii (61)\n" +
        ...
        int bottomProgram = day7_2.recursiveCircus(input);

        Assertions.assertThat(bottomProgram).isEqualTo(60);
    }
    ...
    public void recursiveCircus() {
        ...
        System.out.println("Day 7 part 2: " + day7_2.recursiveCircus(input));
    }
}
