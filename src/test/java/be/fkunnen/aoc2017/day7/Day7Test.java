...
public class Day7Test {
    ...
    public void recursiveCircus_example_tknk() {
        ...
        String bottomProgram = day7.recursiveCircus(input);

        Assertions.assertThat(bottomProgram).isEqualTo("tknk");
    }
    ...
    public void recursiveCircus() {
        ...
        System.out.println("Day 7 part 1: " + day7.recursiveCircus(input));
    }
}
