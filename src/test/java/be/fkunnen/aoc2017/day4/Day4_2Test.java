...
public class Day4_2Test {
    ...
    private Day4_2 day4_2 = new Day4_2();

    @Test
    public void highEntropyPassphrases_1inputLine_1valid() {
        String input = "abcde fghij";

        int numberOfValidPassphrases = day4_2.numberOfValidPassphrases(input);

        assertThat(numberOfValidPassphrases).isEqualTo(1);
    }

    @Test
    public void highEntropyPassphrases_2inputLines_1valid() {
        String input =
                "abcde fghij\n" +
                "abcde xyz ecdab";
    ...
    @Test
    public void highEntropyPassphrases_3inputLines_2valid() {
        String input =
                "abcde fghij\n" +
                "abcde xyz ecdab\n" +
        ...
        assertThat(numberOfValidPassphrases).isEqualTo(2);
    }

    @Test
    public void highEntropyPassphrases_4inputLines_2valid() {
        String input =
                "abcde fghij\n" +
                "abcde xyz ecdab\n" +
                "a ab abc abd abf abj\n" +
    ...
    public void highEntropyPassphrases() {
        ...
        System.out.println("Day 4 part 2: " + day4_2.numberOfValidPassphrases(input));
    }
}
