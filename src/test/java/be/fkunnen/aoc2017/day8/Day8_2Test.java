...
public class Day8_2Test {
    ...
    private Day8_2 day8_2 = new Day8_2();
    ...
    public void registers_example() throws ScriptException {
        ...
        int largestValueInRegisters = day8_2.registers(input);

        Assertions.assertThat(largestValueInRegisters).isEqualTo(10);
    }

    @Test
    public void registers() throws ScriptException {
        String input =
                "ba dec 37 if znx != 0\n" +
